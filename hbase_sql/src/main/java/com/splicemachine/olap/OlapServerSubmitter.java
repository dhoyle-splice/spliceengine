        ...
        try {
            ...
            for (int i = 0; i<maxAttempts; ++i) {
                try {
                    ...
                    String diagnostics = getDiagnostics(path + queueName);
                    if (diagnostics.equals("Shutdown for rolling upgrade")) {
                        stop = true;
                        LOG.error("Shutdown for rolling upgrade");
                    }
