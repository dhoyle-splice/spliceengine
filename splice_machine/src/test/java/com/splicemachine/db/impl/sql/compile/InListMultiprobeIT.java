...
public class InListMultiprobeIT  extends SpliceUnitTest {
    ...
    public static void createData(Connection conn, String schemaName) throws Exception {
        ...
        new TableCreator(conn)
                .withCreate("create table t111 (a1 bigint,\n" +
                "                 b1 decimal(38,0),\n" +
                "                 c1 char(5),\n" +
                "                 d1 int,\n" +
                "                 e1 smallint,\n" +
                ...
                "                 g1 bigint,\n" +
                "                 h1 timestamp)")
                .withIndex("create index t111_ix1 on t111(a1 DESC,b1 DESC,c1 DESC,d1 DESC,e1 DESC,f1 DESC,g1 DESC,h1 DESC)")
                .create();

        spliceClassWatcher.executeUpdate("insert into t111 select * from t11");
        spliceClassWatcher.executeQuery(format("analyze table %s.t111", CLASS_NAME));
    ...
    public void TestDifferentNumbersOfProbes() throws Exception {
        ...
        for (int numProbes:probes) {
            ...
            TestDifferentNumberOfProbesMain("t111");
        }
        // Reset derby.database.maxMulticolumnProbeValues to the default setting.
        spliceClassWatcher.execute("call syscs_util.syscs_set_global_database_property('" + Property.MAX_MULTICOLUMN_PROBE_VALUES + "', null)");
    }
